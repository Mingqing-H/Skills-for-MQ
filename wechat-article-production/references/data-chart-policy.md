...
Use this whenever the article needs a line chart, bar chart, histogram, scatter plot, timeline with numeric values, or any professional data visualization.
...
- Render final charts as PNG for WeChat. SVG may be kept only as an editable source.
...
4. Write task-specific chart code to render PNG. Choose the library and visual style for the article instead of using a fixed template.
...
- Source cards are not data charts.
